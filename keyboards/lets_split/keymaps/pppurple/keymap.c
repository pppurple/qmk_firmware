 ...
 */
[_LOWER] = KEYMAP( \
  KC_EXLM,S(KC_QUOT),KC_HASH,  KC_DLR,    KC_PERC, KC_AMPR, KC_QUOT, KC_LPRN, KC_RPRN, KC_EQL,  KC_TILD, KC_PIPE, \
  _______, _______,  KC_NUHS,  KC_NUBS,   KC_CIRC, KC_ASTR, KC_PLUS, KC_LCBR, KC_RCBR, KC_MINS, KC_AT,   KC_GRV, \
  _______, _______, S(KC_NUHS),S(KC_NUBS),_______, _______, _______, KC_LBRC, KC_RBRC, KC_UNDS, KC_BSLS, _______, \
  _______, _______,  _______,  _______,   _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
),
...
[_ADJUST] =  KEYMAP( \
  ...
  _______, _______, _______, _______, _______, KC_1,    _______, _______, _______, _______, _______, _______, \
